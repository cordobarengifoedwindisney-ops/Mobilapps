...
price: 90.0, 
imageUrl: "https://http2.mlstatic.com/D_NQ_NP_928830-CBT77640147622_072024-O.webp", 
rating: 4.8, 
description: 
...
price: 250.0, 
imageUrl: "https://cdn.mos.cms.futurecdn.net/fgvEZRacdHbG4GAzA25AQj-1920-80.jpg", 
rating: 4.2, 
description: 
...
const Review( 
author: "Carlos M.", 
comment: "Excelente servicio y productos de gran calidad. Mi laptop llegó muy rápido y en perfectas 
condiciones.", 
rating: 5.0, 
), 
const Review( 
author: "Laura P.", 
comment: "Compré un monitor y funciona perfectamente. La imagen es increíble y la entrega fue puntual.", 
rating: 4.5, 
), 
const Review( 
author: "Andrés R.", 
comment: "Muy buenos precios y entrega rápida. Los audífonos son top! Volvería a comprar aquí sin dudar.", 
rating: 4.0, 
), 
const Review( 
author: "Sofía G.", 
comment: "La atención al cliente es fantástica, me ayudaron a elegir el smartphone ideal. Totalmente 
recomendados.", 
rating: 5.0, 
), 
const Review( 
author: "Diego F.", 
comment: "El teclado mecánico es una maravilla, muy cómodo y la retroiluminación es genial. ¡Excelente 
compra!", 
rating: 4.8, 
), 
const Review( 
...
Offer(product: _allProducts[2], discountPercentage: 0.25), // Audífonos Bluetooth 
Offer(product: _allProducts[3], discountPercentage: 0.10), // Monitor UltraWide 
...
icon: const Icon(Icons.shopping_cart), 
              onPressed: () { 
                Navigator.push( 
                  context, 
                  MaterialPageRoute<Carrito>(builder: (BuildContext context) => const Carrito()), 
                ); 
              }, 
            ), 
            if (itemCount > 0) 
      ...
      child: Card( 
        ...
        child: Column( 
          ...
          children: <Widget>[ 
            Expanded( 
              child: Hero( 
                tag: 'productImage_${product.id}', // Unique tag for Hero animation 
                child: ClipRRect( 
      ...
      child: InkWell( 
        onTap: () { 
          Navigator.push( 
            context, 
            MaterialPageRoute<ProductDetailsPage>( 
              builder: (BuildContext context) => ProductDetailsPage(product: offer.product), 
            ), 
          ); 
        }, 
        child: Padding( 
          ...
          child: Row( 
            children: <Widget>[ 
              ClipRRect( 
                borderRadius: BorderRadius.circular(8), 
                child: Hero( 
                  tag: 'productImage_${offer.product.id}_offer', // Unique tag for Hero animation 
                  child: Image.network( 
...
textAlign: TextAlign.justify, 
            ...
            Padding( 
              padding: const EdgeInsets.symmetric(horizontal: 15), 
              child: Column( 
                children: _allReviews.map<ReviewCard>((Review review) => ReviewCard(review: review)).toList(), 
              ), 
            ), 
...
category == null ? _allProducts : _allProducts.where((Product product) => product.category == 
category).toList(); 
return Scaffold( 
appBar: AppBar( 
...
fit: BoxFit.cover, 
errorBuilder: (BuildContext context, Object error, StackTrace? stackTrace) => 
const SizedBox(height: 300, child: Center(child: Icon(Icons.image_not_supported, size: 100, color: 
Colors.grey))), 
              ), 
            ), 
            Padding( 
              ...
              child: Column( 
                ...
                children: <Widget>[ 
                  ...
                  if (product.specifications.isNotEmpty) ...<Widget>[ 
                    ...
                    const SizedBox(height: 10), 
                    Column( 
                      children: product.specifications.map<Widget>((Map<String, String> spec) { 
                        return Padding( 
...
const SizedBox(height: 10), 
Column( 
children: _allReviews.map<ReviewCard>((Review review) => ReviewCard(review: 
review)).toList(), 
), 
], 
), 
    ...
    return Scaffold( 
      ...
      body: ListView( 
        children: <Widget>[ 
          ...
          const SizedBox(height: 15), 
          ..._allOffers.map<OfferCard>((Offer offer) => OfferCard(offer: offer)).toList(), 
          const SizedBox(height: 20), 
        ], 
      ), 
    ); 
...
Text( 
"ProvTecno", 
style: Theme.of(boatContext).textTheme.headlineMedium?.copyWith(fontWeight: 
FontWeight.bold), 
textAlign: TextAlign.center, 
), 
const SizedBox(height: 15), 
